...
class RNN4Music:
    ...
    def train(self, dataset, noOfEpochPerMB, noOfEpoch, sizeOfMiniBatch):
        '''
	...
	# D_YtAccR, KLAccR, Tc1AccR, Tc2AccR, Tc3AccR, Th1AccR, Th2AccR, Th3AccR] = self.gradSingleTune(T_egMB, T_egOutMB)
...
#	def gradSingleTune(self, T_egMB, T_egOutMB, Thtd1_1, Thtd1_2, Thtd1_3, Tctd1_1, Tctd1_2, Tctd1_3):
	...
	#blah insert scan here for MB, then take mean before RMS prop below :-)
	...
	#useful prints function structure to file:
        ...
        for n in np.arange(noOfEpoch):
                ...
                for n in np.arange(0,sizeOfMiniBatch,1): #np.array(dataset).shape[0],1):
                        mbDataset.append(dataset[tuneIndex[n]][0:tuneLength])
                #print("MB dataset.shape = " + str(np.array(mbDataset)[0:sizeOfMiniBatch,0:tuneLength-2,:].shape))
